...
public:
	...
	nMasternodeColleteralLimxDev = 3000; //Params().MasternodeColleteralLimxDev()
        ...
        const char* pszTimestamp = "15 may 2018 WorldGreenCoin starting save the World!!!";
...
//        vSeeds.push_back(CDNSSeedData("seed1.worldGreenCoin.info", "seed1.worldGreenCoin.info"));
//        vSeeds.push_back(CDNSSeedData("seed2.worldGreenCoin.info", "seed2.worldGreenCoin.info"));
        vFixedSeeds.clear();
        vSeeds.clear();
        ...
        nStartMasternodePayments = 1526515200;
    }
...
public:
    CTestNetParams()
    {
        ...
        // Testnet WorldGreenCoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet WorldGreenCoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet WorldGreenCoin BIP44 coin type is '1' (All coin's testnet default)
