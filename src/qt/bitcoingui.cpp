                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("WorldGreenCoin-Coin") + " - ";
#ifdef ENABLE_WALLET
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About WorldGreenCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about WorldGreenCoin Core"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("WorldGreenCoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("WorldGreenCoin Core"); // default title
