/* src/config/worldGreenCoin-config.h.  Generated from worldGreenCoin-config.h.in by configure.  */
/* src/config/worldGreenCoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://worldGreenCoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "WorldGreenCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "WorldGreenCoin Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "worldGreenCoin"
