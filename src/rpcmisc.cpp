...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"Darksend_balance\": xxxxxx, (numeric) the anonymized worldGreenCoin balance of the wallet\n"
            ...
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in worldGreenCoin/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in worldGreenCoin/kb\n"
...
#ifdef ENABLE_WALLET
        // Case 1: WGC address and we have full public key:
