...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* WGC features */
        {"worldGreenCoin", "masternode", &masternode, true, true, false},
        {"worldGreenCoin", "masternodelist", &masternodelist, true, true, false},
        {"worldGreenCoin", "mnbudget", &mnbudget, true, true, false},
        {"worldGreenCoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"worldGreenCoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"worldGreenCoin", "mnsync", &mnsync, true, true, false},
        {"worldGreenCoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"worldGreenCoin", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use worldGreenCoind, or the -server option to worldGreenCoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
