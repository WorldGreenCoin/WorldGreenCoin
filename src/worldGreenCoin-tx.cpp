...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("WorldGreenCoin Core worldGreenCoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  worldGreenCoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded worldGreenCoin transaction") + "\n" +
                               "  worldGreenCoin-tx [options] -create [commands]   " + _("Create hex-encoded worldGreenCoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded worldGreenCoin transaction
