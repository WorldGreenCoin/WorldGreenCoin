...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='worldGreenCoin.conf'
CONFIGFOLDER='/root/.worldGreenCoin'
COIN_DAEMON='worldGreenCoind'
COIN_CLI='worldGreenCoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/WorldGreenCoin/worldGreenCoin.git'
COIN_TGZ=''
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='WorldGreenCoin'
COIN_PORT=17121
RPC_PORT=17122
